...
public class MainMenuNew : MonoBehaviour {
    ...
    [SerializeField]
    private RegisterColors registerColors;
	...
	void Start(){
        ...
        GlobalController.loadHighScores();
	}
    ...
    /** Play **/
	public void NewGame(){
		if(sceneName[PlayerPrefs.GetInt("map")] != ""){
			StartCoroutine(LoadAsynchronously(sceneName[PlayerPrefs.GetInt("map")]));
    ...
    void saveChange()
    {
        globalController.Car_colors = registerColors.getMap();
    }
